...
async function sendResetOTP() {
  ...
  try {
    const res = await fetch("https://trekfast.onrender.com/send-reset-otp", {
      method: "POST",
...
document.getElementById("forgotForm").addEventListener("submit", async (e) => {
  ...
  try {
    ...
    // ===== Verify OTP =====
    const verifyRes = await fetch("https://trekfast.onrender.com/verify-reset-otp", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    // ===== Reset Password =====
    const res = await fetch("https://trekfast.onrender.com/reset-password", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
